...
def index(req):
    ...
    panelbegin = """
        ...
        <div class="col-sm-4"><center class='list-group-item-text'><h1>NEW MOVIE COPIES</h1>
        ...
        <tr><th>Assign Rental Fee</th><td><input type='text' name='rentfee'></td></tr>
        ...
        <iframe src='genview.py' width='600px' height='700px' noframe>
        </div>
        </div>
        </div>
