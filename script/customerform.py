...
def customershow():
    ...
    curr = conn.cursor()
    curr.execute("""
                 select * from tblcustomer order by cid desc
                 """)
    rows = curr.fetchall()
    return rows
def index(req):
    ...
    panelbegin = """
        ...
        role="button">Click Here To Add New Renter</a href>
        </div>
